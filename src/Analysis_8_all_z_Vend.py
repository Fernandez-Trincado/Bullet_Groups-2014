...
print 'z=0'    ,len(dist_2d_XY_h_z0[(dist_2d_XY_h_z0>=64.*0.001)&(dist_2d_XY_h_z0<=350.*0.001)]), np.min(dist_2d_XY_h_z0[(dist_2d_XY_h_z0>=64.*0.001)&(dist_2d_XY_h_z0<=350.*0.001)]), np.max(dist_2d_XY_h_z0[(dist_2d_XY_h_z0>=64.*0.001)&(dist_2d_XY_h_z0<=350.*0.001)])
print 'z=0.25' ,len(dist_2d_XY_h_z3[(dist_2d_XY_h_z3>=64.*0.001)&(dist_2d_XY_h_z3<=350.*0.001)]), np.min(dist_2d_XY_h_z3[(dist_2d_XY_h_z3>=64.*0.001)&(dist_2d_XY_h_z3<=350.*0.001)]), np.max(dist_2d_XY_h_z3[(dist_2d_XY_h_z3>=64.*0.001)&(dist_2d_XY_h_z3<=350.*0.001)])
print 'z=0.5'  ,len(dist_2d_XY_h_z2[(dist_2d_XY_h_z2>=64.*0.001)&(dist_2d_XY_h_z2<=350.*0.001)]), np.min(dist_2d_XY_h_z2[(dist_2d_XY_h_z2>=64.*0.001)&(dist_2d_XY_h_z2<=350.*0.001)]), np.max(dist_2d_XY_h_z2[(dist_2d_XY_h_z2>=64.*0.001)&(dist_2d_XY_h_z2<=350.*0.001)])
print 'z=1'    ,len(dist_2d_XY_h_z1[(dist_2d_XY_h_z1>=64.*0.001)&(dist_2d_XY_h_z1<=350.*0.001)]), np.min(dist_2d_XY_h_z1[(dist_2d_XY_h_z1>=64.*0.001)&(dist_2d_XY_h_z1<=350.*0.001)]), np.max(dist_2d_XY_h_z1[(dist_2d_XY_h_z1>=64.*0.001)&(dist_2d_XY_h_z1<=350.*0.001)])

print 'Group sample'

print 'z=0'    ,len(dist_2d_XY_s_z0[(dist_2d_XY_s_z0>=64.*0.001)&(dist_2d_XY_s_z0<=350.*0.001)]), np.min(dist_2d_XY_s_z0[(dist_2d_XY_s_z0>=64.*0.001)&(dist_2d_XY_s_z0<=350.*0.001)]), np.max(dist_2d_XY_s_z0[(dist_2d_XY_s_z0>=64.*0.001)&(dist_2d_XY_s_z0<=350.*0.001)])
print 'z=0.25' ,len(dist_2d_XY_s_z3[(dist_2d_XY_s_z3>=64.*0.001)&(dist_2d_XY_s_z3<=350.*0.001)]), np.min(dist_2d_XY_s_z3[(dist_2d_XY_s_z3>=64.*0.001)&(dist_2d_XY_s_z3<=350.*0.001)]), np.max(dist_2d_XY_s_z3[(dist_2d_XY_s_z3>=64.*0.001)&(dist_2d_XY_s_z3<=350.*0.001)])
print 'z=0.5'  ,len(dist_2d_XY_s_z2[(dist_2d_XY_s_z2>=64.*0.001)&(dist_2d_XY_s_z2<=350.*0.001)]), np.min(dist_2d_XY_s_z2[(dist_2d_XY_s_z2>=64.*0.001)&(dist_2d_XY_s_z2<=350.*0.001)]), np.max(dist_2d_XY_s_z2[(dist_2d_XY_s_z2>=64.*0.001)&(dist_2d_XY_s_z2<=350.*0.001)])
print 'z=1'    ,len(dist_2d_XY_s_z1[(dist_2d_XY_s_z1>=64.*0.001)&(dist_2d_XY_s_z1<=350.*0.001)]), np.min(dist_2d_XY_s_z1[(dist_2d_XY_s_z1>=64.*0.001)&(dist_2d_XY_s_z1<=350.*0.001)]), np.max(dist_2d_XY_s_z1[(dist_2d_XY_s_z1>=64.*0.001)&(dist_2d_XY_s_z1<=350.*0.001)])

# Dark Matter - Baryon

print 'Cluster sample'

print 'z=0 '   ,len(distbarion_h_z0[(dist_2d_XY_h_z0>=64.*0.001)&(dist_2d_XY_h_z0<=350.*0.001)])#[distbarion_h_z0[(dist_2d_XY_h_z0>=64.*0.001)&(dist_2d_XY_h_z0<=350.*0.001)]>=87.])
print 'z=0.25 ',len(distbarion_h_z3[(dist_2d_XY_h_z3>=64.*0.001)&(dist_2d_XY_h_z3<=350.*0.001)])#[distbarion_h_z3[(dist_2d_XY_h_z3>=64.*0.001)&(dist_2d_XY_h_z3<=350.*0.001)]>=87.])
print 'z=0.5 ' ,len(distbarion_h_z2[(dist_2d_XY_h_z2>=64.*0.001)&(dist_2d_XY_h_z2<=350.*0.001)])#[distbarion_h_z2[(dist_2d_XY_h_z2>=64.*0.001)&(dist_2d_XY_h_z2<=350.*0.001)]>=87.])
print 'z=1 '   ,len(distbarion_h_z1[(dist_2d_XY_h_z1>=64.*0.001)&(dist_2d_XY_h_z1<=350.*0.001)])#[distbarion_h_z1[(dist_2d_XY_h_z1>=64.*0.001)&(dist_2d_XY_h_z1<=350.*0.001)]>=87.])

print 'Group sample'

print 'z=0 '   ,len(distbarion_s_z0[(dist_2d_XY_s_z0>=64.*0.001)&(dist_2d_XY_s_z0<=350.*0.001)])#[distbarion_s_z0[(dist_2d_XY_s_z0>=64.*0.001)&(dist_2d_XY_s_z0<=350.*0.001)]>=87.])
print 'z=0.25 ',len(distbarion_s_z3[(dist_2d_XY_s_z3>=64.*0.001)&(dist_2d_XY_s_z3<=350.*0.001)])#[distbarion_s_z3[(dist_2d_XY_s_z3>=64.*0.001)&(dist_2d_XY_s_z3<=350.*0.001)]>=87.])
print 'z=0.5 ' ,len(distbarion_s_z2[(dist_2d_XY_s_z2>=64.*0.001)&(dist_2d_XY_s_z2<=350.*0.001)])#[distbarion_s_z2[(dist_2d_XY_s_z2>=64.*0.001)&(dist_2d_XY_s_z2<=350.*0.001)]>=87.])
print 'z=1 '   ,len(distbarion_s_z1[(dist_2d_XY_s_z1>=64.*0.001)&(dist_2d_XY_s_z1<=350.*0.001)])#[distbarion_s_z1[(dist_2d_XY_s_z1>=64.*0.001)&(dist_2d_XY_s_z1<=350.*0.001)]>=87.])
...
#a1.errorbar((186./1000.,186./1000.),(0.54,0.54),xerr=30./1000.,yerr=[_min,_max],fmt='o',color='red',elinewidth=2)
##a1.plot(186./1000.,0.54,'.',ms=10,color='red')
#a1.set_xlabel(r'$d_{2D}$($h^{-1}$Mpc)',fontsize=size_)
#a1.set_ylabel(r'$V_{c,sub}$/$V_{c,host}$',fontsize=size_)
#a1.set_title('$V_{c,host}>700$ kms$^{-1}$',fontsize=size_)
#a1.tick_params(labelsize=size_)
#a1.set_xlim(0,1.5)
#a1.set_ylim(0,1.)
#
##------------------------------------------------------------------------------------------------------------------------------------
...
#a2.errorbar((186./1000.,186./1000.),(0.54,0.54),xerr=30./1000.,yerr=[_min,_max],fmt='o',color='red',elinewidth=2)
##a2.plot(186./1000.,0.54,'o',ms=10,color='red')
#a2.set_xlabel(r'$d_{2D}$($h^{-1}$Mpc)',fontsize=size_)
#a2.set_ylabel(r'V$_{c,sub}$/$V_{c,host}$',fontsize=size_)
#a2.set_title('$300$ km s$^{-1} < V_{c,host} < 700 $ km s$^{-1}$',fontsize=size_)
#a2.tick_params(labelsize=size_)
#a2.set_xlim(0,0.5)
#a2.set_ylim(0,1.)
#
#------------------------------------------------------------------------------------------------------------------------------------
f=plt.figure(3)#,(36,14))
#------------------------------------------------------------------------------------------------------------------------------------
size_=30
...
a1.set_xlabel(r'$D_{off}$',fontsize=size_)
a1.set_ylabel(r'$\mu$',fontsize=size_)
a1.set_title('V$_{c,host}>700$ kms$^{-1}$\n',fontsize=size_)
a1.tick_params(labelsize=size_)
...
a2.set_xlabel(r'$D_{off}$',fontsize=size_)
a2.set_ylabel(r'$\mu$',fontsize=size_)
a2.set_title('$300$ km s$^{-1} < $V$_{c,host} < 700 $ km s$^{-1}$\n',fontsize=size_)
a2.tick_params(labelsize=size_)
...
#
#ax.set_ylabel(r'P(>$d_{2D}^{bar}$)',fontsize=30)
#ax.set_xlabel(r'$d_{2D}^{bar}$ $h^{-1}$Mpc',fontsize=30)
