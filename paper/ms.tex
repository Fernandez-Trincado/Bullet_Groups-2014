...
each population is listed on the first row of Table \ref{table:numbers}. 
...
with head-on collissions, $|\mu|>0.9$, we distinguish ystems with
$\mu<-0.9$ and large displacements $D_{\rm   off}>0.6$ most probably
describe the beginning of the interaction and should have baryonic
displacements equal to zero. In all the other cases, the DM-baryon displacement
should be different from zero. We approximate this displacement by  $d_{\rm
