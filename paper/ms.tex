...
\caption{2D histograms in the plane $\mu$-$D_{\rm off}$ describing the
  ...
  The three rectangles (continous, dashed, dashed-dotted)
...
These regions are shown as three different rectangled in Figure
\ref{fig:geometry}. 
...
We thank the referee for a report that improved the readibility of our
results. 
