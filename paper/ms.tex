...
\title{The Abundance of Bullet-like Groups in $\Lambda$CDM}
...
\citep{Milosavljevic2007,Springel2007,Mastropietro20008} and its
...
conditions (merger rates, maximum possible displacement) are a funcion
...
volume of 250\hMpc comoving on a side \citep{2011ApJ...740..120K}. The
...
$\vec{r}$ correspond to the minium of potential and the velocities
...
\caption{2D histograms in the plane $\mu$-$D_{\rm off}$. The left
  ...
  used to construct this histogram includes halos at all
  redshifts. This approximation to increase the statistical power of
  the sample is justified because the redshift evolution of this plot
  is weak.} 
\label{fig:geometry}
\end{figure*}
