...
in a mass resolution of $1.35 \times 10^8$ M$_{\odot}$h$^{-1}$. \citet{2011ApJ...740..102K}. 

\section{Bullet Geometry and Measurement Setup}
\label{sec:setup}

The configuration of this system is shown in  Figure
\ref{configuration}, where can be distinguish the host halo and
substructure for the a particular configuration in z$=0$ and the 
...
\begin{figure*}
\begin{center}
\includegraphics[width=0.90\textwidth]{Figures_eps/Bullet_Group.eps}
\end{center}
...
for different z. The top panel is represented to the sample with $\nu>700$ kms$^{-}1$ and down panel is represented 
for $\nu<700$ kms$^{-1}$} 
\label{cos_theta1}
\end{figure*}
...
\end{center}
\caption{Distributions of $\nu_{circ,Halo}/\nu_{circ,Sub}$ for differents z. The left panel correpond to the sample 
with $\v>700$ kms$^{-1}$ and right panel correpond to the sample with $\nu<700$ kms$^{-1}$.} 
\label{cos_theta2}
\end{figure*}
