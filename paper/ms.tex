...
for collision features in low mass clusters and groups. 
\end{abstract}
...
\begin{figure*}
\begin{center}
\includegraphics[width=0.9\textwidth]{figure_1_V3.eps}
\end{center}
\caption{
...
\begin{figure*}
\begin{center}
\includegraphics[width=1.0\textwidth]{figure_3_V3.eps}
\end{center}
