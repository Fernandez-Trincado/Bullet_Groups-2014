...
against this sample. The table shows that $\sim 40\%$ of the 
...
cosmology and that our estimates for the relative number of bullet
systems with respect to multi-modal systems is compatible with
observations.
 
A proper comparison must take into account all the observational
