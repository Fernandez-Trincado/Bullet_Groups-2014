...
dominant density peaks in dark matter halos simulated in a full
cosmological context. We use as a benchmark the
...
baryonic component. The study extends previous theoretical studies by
simulating two samples: groups and clusters. We find that 50\% to 60\%
...
$133\pm21$\hkpc observed in \bullg. For dark matter halos with
...
previous studies of dark matter to baryon separations in clusters. The
extension of the theoretical predictions and observational results
towards low mass Bullet-like configurations, i.e. larger abundance of
systems,  opens up the possibility for a new statistical test of
$\Lambda$CDM.  
