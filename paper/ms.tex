...
dominant dark matter peaks in two groups of halos corresponding to
galaxy groups and clusters. We find that 50\% to 60\% of the dark
matter  with circular velocities in the range $300\kms$ to $700\kms$
(groups) show multimodal morphologies with displacements between the
dark matter clumps equal or larger than $133\pm21$\hkpc, which
corresponds to the observational constraint the object SL2S
J08544-0121 located at $z=0.35$ which has a velocity dispersion of
$644^{+69}_{-102}\kms$. For dark matter halos with circular velocities
larger than $700\kms$ (clusters) this fraction rises to $80\%$ to
$85\%$. Using the same simulation we estimate the dark
matter-to-baryon spatial separation and find that that $0.1\%$ to
$1.0\%$ of the low mass systems should present separations equal or
larger than $87\pm 14$\hkpc corresponding to the same observational
benchmark; for halos with circular velocities larger than $700\kms$
this fraction is in the range of $4\%$ to $10\%$, consistent with
previous studies of dark matter to baryon separations in
clusters. These results present a weak dependence with redshift. 
\end{abstract}
...
the existence of dark matter. Quantifying the displacement between dark
...
by quantifying the substructure velocity required to produce such
...
to identify multi-modal dark matter clumps in the circular velocity
range $300-700$\kms. 
...
$10041, 10346, 10554,$ and $10382$ host halos with circular velocities
$V_{\rm c}\geq 300$\kms; and $157853, 177331, 195072, 225188$
sub-halos with circular velocities $V_{\rm c}\geq 75$\kms,
respectively. These two sets of halos constitute the basis for our
analysis. 

For each host halo we find its most massive sub-halo. Each pair
host/sub-halo is considered as a potential Bullet system and is kept
got the analysis described in the next section.
...
\subsection{Reproducibility of our results}
